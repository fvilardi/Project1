...
function Checkout() {
  ...
  return (
    <React.Fragment>
      <div
        className="row"
        style={{ marginLeft: "3.5in", marginRight: "3.5in" }}
      >
        <div
          style={{
            flex: 2,
            ...
            >
              <Form>
                <div
                  ...
                  style={{ marginLeft: ".8in", maxWidth: "30%" }}
                >
        ...
        >
          ...
          <>
            ...
            >
              <div style={{ flex: 2 }}>
                {" "}
                Items ({state.shoppingCartData.quantity})
              </div>
            ...
            >
              ...
              <div style={{ flex: 1, textAlign: "right" }}>
                <h4>
                  <strong>
                    {state.shoppingCartData.totalPrice.toFixed(2)} AED
                  </strong>
                </h4>
              </div>
            </div>
