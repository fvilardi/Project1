...
function Subscribers() {
  ...
  const handleSearchSubscribers = () => {
    ...
    newsletterSubscriptionService
      .searchSubscribers(
        ...
        subscriberData.pageSize,
        subscriberData.search
      )
  ...
  const onSearchSubscribersSuccess = (response) => {
    ...
    setSubscriberData((prevState) => {
      ...
      srchSubscriber.subscriberComponents =
        arrayofSubscriber.map(mapSubscriber);
  ...
  const mapSubscriber = (aSubscriber) => {
    ...
    return (
      ...
      >
        ...
        <div>
          <button
            onClick={() => unSubscribe(aSubscriber)}
            className="remove style-3"
          >
